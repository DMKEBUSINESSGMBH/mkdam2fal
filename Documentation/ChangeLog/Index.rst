...
|         | fieldname will be filled with 'categories' in the sys_category_record_mm tab |
|         | usage of the new data model for the categories                               |
+---------+------------------------------------------------------------------------------+
| 1.0.10  | bugfixes and cleanup                                                         |
|         | Dependency to rn_base. Bugfix and info message für Media-Tag conversion      |
|         | convert media-Tags in tt_news                                                |
+---------+------------------------------------------------------------------------------+
